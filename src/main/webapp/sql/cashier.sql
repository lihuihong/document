...
REPLACE INTO `document` (`id`, `type_info_id`, `Fire_control`, `environmental_protection`, `hygiene`, `business_circles`, `status`, `type`) VALUES
...
-- 正在导出表  document.places 的数据：~1 rows (大约)
...
-- 正在导出表  document.places_alteration 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `places_alteration` DISABLE KEYS */;
REPLACE INTO `places_alteration` (`id`, `type_info_id`, `unit_name`, `unit_name_time`, `legal_representative`, `representative_time`, `address`, `address_time`, `area`, `area_time`, `box_quantity`, `box_quantity_time`, `status`, `type`) VALUES
...
-- 正在导出表  document.punishment 的数据：~1 rows (大约)
/*!40000 ALTER TABLE `punishment` DISABLE KEYS */;
REPLACE INTO `punishment` (`id`, `type_info_id`, `warning`, `warning_time`, `fine`, `fine_time`, `rectify`, `rectify_time`, `revocation_permit`, `revocation_permit_time`, `confiscation_income`, `confiscation_income_time`, `confiscation_property`, `confiscation_property_time`, `status`, `type`) VALUES
...
REPLACE INTO `representative` (`id`, `type_info_id`, `name`, `sex`, `birth`, `translate`, `photo`, `political_outlook`, `degree`, `address`, `idcard`, `landline`, `phone`, `status`, `type`, `alias`) VALUES
...
-- 正在导出表  document.singing 的数据：~3 rows (大约)
/*!40000 ALTER TABLE `singing` DISABLE KEYS */;
REPLACE INTO `singing` (`id`, `type_info_id`, `child`, `unit_name`, `business_address`, `management`, `work_telephone`, `operating_area`, `box_quantity`, `performance_area`, `number_equipment`, `total_investment`, `license_key`, `Issuing_time`, `certification_authority`, `inspection_time`, `rules`, `number_people_employed`, `authorized_number`, `status`, `type`) VALUES
(7, 1, NULL, '1', '1', '1', '12321232123', '1', '1', '1', '3', '1', '1', '2019-05-17', '1', '2019-05-17', '0', '1', '1', 0, 0),
(8, 1, NULL, '二', '二二', '1', '12321232123', '12', '12', '12', '12', '12', '12222', '2019-05-22', '11我 ', '2019-05-29', '1', '12', '12', 0, 2),
(9, NULL, NULL, '阿萨', '阿萨', '1', '12345678909', '12', '12', '121', '12', '121', '1211', '2019-05-28', '112', '2019-05-15', '0', '12', '12', 0, 2);
...
-- 正在导出表  document.sing_alteration 的数据：~2 rows (大约)
/*!40000 ALTER TABLE `sing_alteration` DISABLE KEYS */;
REPLACE INTO `sing_alteration` (`id`, `type_info_id`, `unit_name`, `unit_name_time`, `legal_representative`, `representative_time`, `address`, `address_time`, `area`, `area_time`, `box_quantity`, `box_quantity_time`, `status`, `type`) VALUES
(4, 1, '1', '2019-06-06', '1', '2019-05-16', '1', '2019-05-16', '1', '2019-05-07', '1', '2019-05-21', 0, 0),
(5, 1, '分隔符', '2019-05-17', '分隔符', '2019-05-17', '分隔符', '2019-05-17', '12', '2019-05-15', '121', '2019-05-22', 0, 1);
...
REPLACE INTO `user_info` (`id`, `name`, `password`, `type`, `type_info_id`) VALUES
