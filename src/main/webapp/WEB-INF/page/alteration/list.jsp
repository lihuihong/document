    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                {field: 'terminalNumbe', title: '终端台数', align: 'center'},
                {field: 'terminalNumbeTime', title: '终端台数时间', align: 'center', hide: true},
                {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/alteration/edit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/alteration/examine',
                    zIndex: layer.zIndex, //重点1
