...
<form class="layui-form">
    <div class="layui-form-item layui-elem-quote">
        ...
        <button type="button" class="layui-btn layui-btn-normal btnAdd">+ 新增法律代表人</button>
    </div>
</form>
...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#tableList'
            , url: '/document/representative/list'
            ...
            , cols: [[
                ...
                {field: 'photo', title: '照片', align: 'center', hide: true},
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/representative/edit',
            ...
            if (obj.event === 'del') {
                layer.confirm('法律代表人：' + data.name, {icon: 3, title: '是否确定删除?'}, function (index) {
                    $.ajax({
                        url: '/document/representative/del',
                        type: 'post',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/representative/examine',
                    zIndex: layer.zIndex, //重点1
