...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px ;text-align: center" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="boxQuantity" id="boxQuantity"  lay-verify="required|number" placeholder="请输入包厢数量" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">表演区（大厅）面积（m2）</label>
        <div class="layui-input-block">
            <input type="text" name="performanceArea" id="performanceArea"  lay-verify="required|number" placeholder="请输入表演区（大厅）面积（m2）" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">点歌设备台数</label>
        <div class="layui-input-block">
            <input type="text" name="numberEquipment" id="numberEquipment"  lay-verify="required|number" placeholder="请输入点歌设备台数" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">总投资额（万元）</label>
        <div class="layui-input-block">
            <input type="text" name="totalInvestment" id="totalInvestment"  lay-verify="required|number" placeholder="请输入总投资额（万元）" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="numberPeopleEmployed" id="numberPeopleEmployed"  lay-verify="required" placeholder="请输入从业人员数" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">核定人数</label>
        <div class="layui-input-block">
            <input type="text" name="authorizedNumber" id="authorizedNumber"  lay-verify="required" placeholder="请输入核定人数" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    layui.use(['form','laydate'], function() {
        ...
        if (info != null){
            form.val('form',{
                ...
                ,"boxQuantity":info.boxQuantity
                ,"performanceArea":info.performanceArea
                ,"numberEquipment":info.numberEquipment
                ,"licenseKey":info.licenseKey
                ,"issuingTime":info.issuingTime
                ,"certificationAuthority":info.certificationAuthority
                ,"inspectionTime":info.inspectionTime
                ,"rules":info.rules
                ,"numberPeopleEmployed":info.numberPeopleEmployed
                ,"authorizedNumber":info.authorizedNumber
