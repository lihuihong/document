    ...
    <form class="layui-form">
        <div class="layui-form-item layui-elem-quote">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" id="name" autocomplete="off" placeholder="请输入分类名称" class="layui-input">
            </div>
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field: 'id', title: '分类id', align:'center'},
                {field:'name', title: '名称名称', align:'center'},
        ...
        table.on('tool(demo)', function(obj){
           ...
           if(obj.event === 'edit'){
               ...
               layer.open({
                   ...
                   anim: 0,
                   shade: [0.5, 'rgb(0,0,0)'],
                   content: '/web/page/publication/typeEdit',
                ...
                layer.confirm('分类：'+data.name, {icon: 3, title:'是否确定删除?'}, function(index){
                    $.ajax({
                        url:'/document/typeInfoOne/del',
                        type:'post',
                        data:{'typeInfoOneId':data.id},
                        dataType:"json",
