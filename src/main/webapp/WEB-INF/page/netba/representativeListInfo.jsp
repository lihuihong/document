...
<form class="layui-form">
    <div class="layui-form-item layui-elem-quote">
        ...
        <button type="button" class="layui-btn layui-btn-normal btnAdd">+ 新增负责人</button>
    </div>
</form>
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/netba/representativeEditInfo',
            ...
            if (obj.event === 'del') {
                layer.confirm('负责人：' + data.name, {icon: 3, title: '是否确定删除?'}, function (index) {
                    $.ajax({
