...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px;text-align: center">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="terminalNumbe" id="terminalNumbe"  lay-verify="required|number" placeholder="请输入终端台数" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">终端台数时间</label>
        <div class="layui-input-block">
            <input type="text" name="terminalNumbeTime" id="terminalNumbeTime"  lay-verify="required" placeholder="终端台数时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
