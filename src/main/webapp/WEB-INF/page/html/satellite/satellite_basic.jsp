    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" id="form">
                <input type="hidden" name="typeInfoId" value="10">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="networkAccess" class="col-lg-3 col-sm-3 col-md-3 control-label" title="是否境外">是否境外</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
...
<script>
    ...
    $.ajax({
        ...
        type:'post',
        dataType:"json",
        data:{"page":1,"limit":999,"typeInfoId":10},
        beforeSend:function(){
            //do something
        },
        success:function(data){
