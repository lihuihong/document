        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="area" class="col-lg-3 col-sm-3 col-md-3 control-label" title="服务器地址">服务器地址</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" id="area" name="area" class="form-control" placeholder="请输入服务器地址">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="networkAccess" class="col-lg-3 col-sm-3 col-md-3 control-label" title="IP地址">IP地址</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="networkAccess" name="networkAccess"
                                   placeholder="请输入IP地址">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="service" class="col-lg-3 col-sm-3 col-md-3 control-label" title="服务器数量">服务器数量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="areaTime" class="col-lg-3 col-sm-3 col-md-3 control-label" title=服务器地址变更时间">服务器地址变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="areaTime" name="areaTime"
                                   placeholder="请输入服务器地址变更时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="terminalNumbeTime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="IP地址变更时间">IP地址变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="terminalNumbeTime" name="terminalNumbeTime"
                                   placeholder="请输入IP地址变更时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="servicetime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="服务器数量变更时间">服务器数量变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="servicetime" name="servicetime"
                                   placeholder="请输入服务器数量变更时间">
                        </div>
                    </div>
                </div>
                    <div class="form-btn">
