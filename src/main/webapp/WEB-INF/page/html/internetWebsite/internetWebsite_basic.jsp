        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" id="form">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="ipaddress" class="col-lg-3 col-sm-3 col-md-3 control-label" title="IP地址">IP地址</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                    ...
                    <div class="form-group">
                        <label for="address" class="col-lg-3 col-sm-3  col-md-3 control-label" title="每日最高浏览量"> 每日最高浏览量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="address" name="address"
                                   placeholder="请输入每日最高浏览量">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="ipnumber" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="ICP备案号">ICP备案号</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="ipnumber" name="ipnumber" placeholder="请输入ICP备案号">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <select class="form-control" id="networkAccess" name="networkAccess">
                                <option value="" selected>请选择网络接入商</option>
                    ...
                    <div class="form-group">
                        <label for="program" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="是否传播视听节目">是否传播视听节目</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                    ...
                    <div class="form-group">
                        <label for="service" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="服务器地址">服务器地址</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                    ...
                    <div class="form-group">
                        <label for="numberofServers" class="col-lg-3 col-sm-3  col-md-3 control-label" title="备案号"> 备案号</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
