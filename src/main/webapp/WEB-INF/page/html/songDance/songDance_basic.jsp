        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" id="form">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="performanceArea" class="col-lg-3 col-sm-3 col-md-3 control-label" title="表演区（大厅）面积（m2）">表演区（大厅）面积（m2）</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="performanceArea"
                                   placeholder="请输入表演区（大厅）面积（m2）" name="performanceArea">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="numberPeopleEmployed" class="col-lg-3 col-sm-3 col-md-3 control-label" title="从业人员数">从业人员数</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="numberPeopleEmployed" name="numberPeopleEmployed"
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="boxQuantity" class="col-lg-3 col-sm-3  col-md-3 control-label"
                               title="包厢数量">包厢数量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="boxQuantity" name="boxQuantity"
                                   placeholder="请输入包厢数量">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="numberEquipment" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="点歌设备台数">点歌设备台数</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="numberEquipment" name="numberEquipment"
                                   placeholder="请输入点歌设备台数">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="authorizedNumber" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="核定人数">核定人数</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="authorizedNumber" name="authorizedNumber"
                                   placeholder="请输入核定人数">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="checkbox" class="js-switch" value="0" checked id="rules" name="rules"/>
                        </div>
                    </div>
                </div>
                <div class="form-btn">
