...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt"%><html lang="en">
<html lang="en">
<head>
    <meta charset="utf-8">
            ...
            <form class="form-horizontal" role="form" id="form">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" id="area" class="form-control" placeholder="请输入面积（m2）" name="area">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="boxQuantity" class="col-lg-3 col-sm-3 col-md-3 control-label" title="包厢数量">包厢数量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="boxQuantityTime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="包厢数量变更时间">包厢数量变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="boxQuantityTime" name="boxQuantityTime"
...
<script>
    $('#submit').on('click',function () {
        $.ajax({
            url:'/document/singAlteration/saveOrEdit',
            type:'post',
            data:$("#form").serialize(),
            dataType:"json",
            beforeSend:function(){
    ...
    $.ajax({
        url:'/document/singAlteration/listUser',
        type:'post',
        dataType:"json",
