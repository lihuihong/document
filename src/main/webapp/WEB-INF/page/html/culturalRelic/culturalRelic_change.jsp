        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" id="form">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="legalRepresentative" class="col-lg-3 col-sm-3 col-md-3 control-label" title="法定代表人（所有人变更）">法定代表人 （所有人变更）</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="legalRepresentative" name="legalRepresentative"
                                   placeholder="请输入法定代表人（所有人变更）">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="number" class="col-lg-3 col-sm-3 col-md-3 control-label" title="保护级别">保护级别</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="representativeTime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="法定代表人（所有人变更）变更时间">法定代表人（所有人变更）变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="representativeTime" name="representativeTime"
                                   placeholder="请输入法定代表人（所有人变更）变更时间" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="numbertime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="保护级别变更时间">保护级别变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="numbertime" name="numbertime"
                                   placeholder="请输入保护级别变更时间">
                        </div>
                    </div>
                </div>
                    <div class="form-btn">
