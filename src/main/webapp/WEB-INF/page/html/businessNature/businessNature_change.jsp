        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="area" class="col-lg-3 col-sm-3 col-md-3 control-label" title="面积（m2）">面积（m2）</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" id="area" name="area" class="form-control" placeholder="请输入面积（m2）">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="terminalNumbe" class="col-lg-3 col-sm-3 col-md-3 control-label" title="包厢数量">包厢数量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="terminalNumbe" name="terminalNumbe"
                                   placeholder="请输入包厢数量">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="number" class="col-lg-3 col-sm-3 col-md-3 control-label" title="设备数量">设备数量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="areaTime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="面积（m2）变更时间">面积（m2）变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="areaTime" name="areaTime"
                                   placeholder="请输入面积（m2）变更时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="terminalNumbeTime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="包厢数量变更时间">包厢数量变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="terminalNumbeTime" name="terminalNumbeTime"
                                   placeholder="请输入包厢数量变更时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="numbertime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="设备数量变更时间">设备数量变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="numbertime" name="numbertime"
                                   placeholder="请输入设备数量变更时间">
                        </div>
                    </div>
                </div>
                <div class="form-btn">
