            ...
            <form class="form-horizontal" role="form" id="form">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="unitNameTime"
                                   name="unitNameTime"
                                   placeholder="请输入单位名称变更时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="representativeTime" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="法定代表人变更时间">法定代表人变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="representativeTime"
                                   name="representativeTime"
                                   placeholder="请输入法定代表人变更时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="addressTime" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="地址变更时间">地址变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="addressTime"
                                   name="addressTime"
                    ...
                    <div class="form-group">
                        <label for="terminalNumbeTime" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="终端台数变更时间">终端台数变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="terminalNumbeTime"
                                   name="terminalNumbeTime"
                                   placeholder="请输入终端台数变更时间">
                        </div>
                    </div>
                </div>
                <div class="form-btn">
