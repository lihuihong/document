        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="environmentalProtection" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="环保">环保</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="environmentalProtection"
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="businessCircles" class="col-lg-3 col-sm-3 col-md-3 control-label"
                               title="工商">工商</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
