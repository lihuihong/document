        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="networkAccess" class="col-lg-3 col-sm-3  col-md-3 control-label" title="备案号"> 备案号</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control" id="terminalNumber" name=""
                                   placeholder="请输入设备台数">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <select class="form-control" id="name" name="name">
                                ...
                                <option value="1">摄制</option>
                                <option value="2">进口</option>
                                <option value="3">出口</option>
                                <option value="4">发行</option>
                                <option value="5">放映</option>
                            </select>
                        </div>
                    </div>
                </div>
