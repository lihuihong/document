    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <form class="form-horizontal" role="form" id="form">
                <input type="hidden" name="typeInfoId" value="9">
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="number" class="col-lg-3 col-sm-3 col-md-3 control-label" title="用户数量">用户数量</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                ...
                <div class="col-lg-6 col-sm-6 col-md-6">
                    ...
                    <div class="form-group">
                        <label for="numbertime" class="col-lg-3 col-sm-3 col-md-3 control-label" title="用户数量变更时间">用户数量变更时间</label>
                        <div class="col-lg-9 col-sm-9 col-md-9">
                            <input type="text" class="form-control default-date-picker" id="numbertime" name="numbertime"
                                   placeholder="请输入用户数量变更时间">
                        </div>
                    </div>
                </div>
                    <div class="form-btn">
...
<script>
    ...
    $.ajax({
        ...
        type:'post',
        dataType:"json",
        data:{"page":1,"limit":999,"typeInfoId":9},
        beforeSend:function(){
            //do something
        },
        success:function(data){
