    ...
    layui.use(['table', 'form'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'ipaddress', title: 'IP地址', align:'center',hide:true},
                {field:'ipnumber', title: 'ICP备案号', align:'center',hide:true},
                {field:'service', title: '服务器地址', align:'center',hide:true},
                {field:'program', title: '是否传播视听节目', align:'center',hide:true},
                ...
                {field:'address', title: '每日最高浏览量', align:'center',hide:true},
                {field:'numberofServers', title: '备案号', align:'center',hide:true},
                {field:'networkAccess', title: '网络接入商', align:'center',hide:true},
        ...
        table.on('tool(demo)', function(obj){
           ...
           if(obj.event === 'edit'){
               ...
               layer.open({
                   ...
                   anim: 0,
                   shade: [0.5, 'rgb(0,0,0)'],
                   content: '/web/page/Internet/situationEdit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/Internet/situationExamine',
                    zIndex: layer.zIndex, //重点1
