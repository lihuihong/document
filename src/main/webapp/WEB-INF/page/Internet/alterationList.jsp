    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                {field: 'area', title: '服务器地址', align: 'center', hide: true},
                {field: 'areaTime', title: '服务器地址时间', align: 'center', hide: true},
                {field: 'networkAccess', title: 'IP地址', align: 'center', hide: true},
                {field: 'terminalNumbeTime', title: 'IP地址时间', align: 'center', hide: true},
                {field: 'service', title: '服务器数量', align: 'center', hide: true},
                {field: 'servicetime', title: '服务器数量时间', align: 'center', hide: true},
                {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/Internet/alterationEdit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/Internet/alterationExamine',
                    zIndex: layer.zIndex, //重点1
