...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px;text-align: center">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="areaTime" id="areaTime"  lay-verify="required" placeholder="服务器地址" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">服务器地址时间</label>
        <div class="layui-input-block">
            <input type="text" name="area" id="area"  lay-verify="required" placeholder="服务器地址时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">IP地址</label>
        <div class="layui-input-block">
            <input type="text" name="networkAccess" id="networkAccess"  lay-verify="required" placeholder="IP地址" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">IP地址时间</label>
        <div class="layui-input-block">
            <input type="text" name="terminalNumbeTime" id="terminalNumbeTime"  lay-verify="required" placeholder="IP地址时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">服务器数量</label>
        <div class="layui-input-block">
            <input type="text" name="service" id="service"  lay-verify="required" placeholder="服务器数量" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">服务器数量时间</label>
        <div class="layui-input-block">
            <input type="text" name="servicetime" id="servicetime"  lay-verify="required" placeholder="服务器数量时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
