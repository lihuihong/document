    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                {field: 'terminalNumbe', title: '包厢数量', align: 'center'},
                {field: 'terminalNumbeTime', title: '包厢数量时间', align: 'center', hide: true},
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/video/alterationEdit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/video/alterationExamine',
                    zIndex: layer.zIndex, //重点1
