...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px ;text-align: center" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="performanceArea" id="performanceArea"  lay-verify="required" placeholder="请输入备案号" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">设备台数</label>
        <div class="layui-input-block">
            <input type="text" name="numberEquipment" id="numberEquipment"  lay-verify="required|number" placeholder="请输入设备台数" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        form.on('submit(formDemo)', function(data){
            if (data.field.id !== "" && data.field.id != null){
                layer.confirm('是否确定修改？',{icon: 3, title:'系统信息'},function(index){
                    $.ajax({
                        url:'/document/places/saveOrEdit',
                        type:'post',
                        data:data.field,
                        dataType:"json",
                        beforeSend:function(){
