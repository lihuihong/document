...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px;text-align: center">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="boxQuantityTime" id="boxQuantityTime"  lay-verify="required" placeholder="包厢数量时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    layui.use(['form', 'upload','laydate'], function() {
        ...
        if (info != null){
            form.val('form',{
                ...
                ,"boxQuantityTime":info.boxQuantityTime
            });
            form.render();
        }
