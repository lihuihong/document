    ...
    layui.use(['table', 'form'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'performanceArea', title: '备案号', align:'center',hide:true},
                {field:'numberEquipment', title: '设备台数', align:'center',hide:true},
                {field:'totalInvestment', title: '总投资额（万元）', align:'center',hide:true},
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/places/situationEdit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/places/situationExamine',
                    zIndex: layer.zIndex, //重点1
