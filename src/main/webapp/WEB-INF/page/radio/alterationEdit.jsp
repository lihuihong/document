...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px;text-align: center">
    ...
    <input type="hidden" name="typeInfoId" id="typeInfoId" value="9">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">用户数量</label>
        <div class="layui-input-block">
            <input type="text" name="number" id="number"  lay-verify="required|number" placeholder="请输入用户数量" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">用户数量时间</label>
        <div class="layui-input-block">
            <input type="text" name="numbertime" id="numbertime"  lay-verify="required" placeholder="用户数量时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
