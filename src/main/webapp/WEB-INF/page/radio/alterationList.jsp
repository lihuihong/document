    ...
    layui.use('table', function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                {field: 'number', title: '用户数量', align: 'center', hide: true},
                {field: 'numbertime', title: '用户数量时间', align: 'center', hide: true},
                {
        ...
        table.on('tool(demo)', function (obj) {
            ...
            if (obj.event === 'edit') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/radio/alterationEdit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/radio/alterationExamine',
                    zIndex: layer.zIndex, //重点1
