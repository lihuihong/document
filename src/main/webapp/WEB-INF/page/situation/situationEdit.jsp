...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="numberofServers" id="numberofServers"  lay-verify="required|number" placeholder="请输入服务器台数" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">终端台数</label>
        <div class="layui-input-inline">
            <input type="text" name="terminalNumber" id="terminalNumber"  lay-verify="required|number" placeholder="请输入终端台数" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="address" id="address"  lay-verify="required" placeholder="请输入地区" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        form.on('submit(formDemo)', function(data){
            if (data.field.id !== "" && data.field.id != null){
                layer.confirm('是否确定修改？',{icon: 3, title:'系统信息'},function(index){
                    $.ajax({
                        url:'/document/situation/saveOrEdit',
                        type:'post',
                        data:data.field,
                        dataType:"json",
                        beforeSend:function(){
