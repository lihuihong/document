...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px ;text-align: center" >
    ...
    <input type="hidden" name="typeInfoId" id="typeInfoId" value="10">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">是否境外</label>
        <div class="layui-input-block">
            <select name="networkAccess" id="networkAccess" lay-verify="required">
                <option value="">--请选择是否境外--</option>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">接收卫星</label>
        <div class="layui-input-block">
            <input type="text" name="address" id="address" lay-verify="required" placeholder="请输入经营地址" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="terminalNumber" id="terminalNumber"  lay-verify="required|number" placeholder="请输入用户数" autocomplete="off" class="layui-input">
        </div>
    </div>
