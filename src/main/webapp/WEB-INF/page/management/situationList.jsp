    ...
    layui.use(['table', 'form'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'terminalNumber', title: '用户数', align:'center',hide:true},
                {field:'networkAccess', title: '是否境外', align:'center',hide:true},
                {field:'address', title: '接收卫星', align:'center',hide:true},
        ...
        table.on('tool(demo)', function(obj){
           ...
           if(obj.event === 'edit'){
               ...
               layer.open({
                   ...
                   anim: 0,
                   shade: [0.5, 'rgb(0,0,0)'],
                   content: '/web/page/management/situationEdit',
            ...
            if (obj.event === 'examine') {
                ...
                layer.open({
                    ...
                    anim: 0,
                    shade: [0.5, 'rgb(0,0,0)'],
                    content: '/web/page/management/situationExamine',
                    zIndex: layer.zIndex, //重点1
        ...
        $('.btnAdd').on('click',function(){
            ...
            layer.open({
                ...
                anim: 0,
                shade: [0.5, 'rgb(0,0,0)'],
                content: '/web/page/publication/situationEdit',
                zIndex: layer.zIndex, //重点1
                success: function(layero){
                    //layer.setTop(layero); //顶置窗口
                },
