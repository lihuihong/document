...
<form class="layui-form" lay-filter="form" style="padding: 20px 50px 20px 20px;text-align: center">
    ...
    <input type="hidden" name="typeInfoId" id="typeInfoId" value="4">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="terminalNumbe" id="terminalNumbe"  lay-verify="required|number" placeholder="请输入设备数量" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">设备数量时间</label>
        <div class="layui-input-block">
            <input type="text" name="terminalNumbeTime" id="terminalNumbeTime"  lay-verify="required" placeholder="设备数量时间" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
